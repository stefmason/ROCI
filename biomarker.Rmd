...
biomarker %>% dplyr::select(logIL18, lognadh, logbglob, Lactate, score) %>% gather(marker, value, -score, na.rm=T) %>%
...
biomarker %>% dplyr::select(logIL18, lognadh, logbglob, Lactate, score, APACHE) %>% gather(marker, value, -score, -APACHE, na.rm=T) %>%
