...
#CXR & SOFA
#aes(CXR, colour="royalblue", linetype=4)
#aes(SOFA, colour="darkorange", linetype=3)
#aes(CXRSOFA, colour="maroon", linetype=1)
aes(colour=roccurve)

sofa_plot <- ggroc(list(CXR=roccurve, SOFA=roccurve2, CXRSOFA=roccurve3), aes=c("linetype", "color"), legacy.axes = T) + 
  theme_linedraw() + 
...
#grid.arrange(roc, roc2, roc3, roc4, roc5, ncol=3)
```
