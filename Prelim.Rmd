...
imgs <- imgs %>% mutate(one_quad = ifelse((Quad3==0 | Quad4==0) & lower ==1),1,ifelse((Quad1==0 | Quad2==0) & upper==1),1, ifelse((Quad2==0 | Quad4==0) & left==1),1,ifelse((Quad1==0 | Quad3==0) & right==1),1,0)
